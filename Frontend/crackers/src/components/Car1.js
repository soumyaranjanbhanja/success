        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            ...
            <MDBCol md='4' lg='3' xl='3' className='mx-auto mb-md-0 mb-4'>
              ...
              <p>
                <MDBIcon color='secondary' icon='phone' className='me-3' /> + 91-9934899997
              </p>
              <p>
                <MDBIcon color='secondary' icon='print' className='me-3' /> + 91-8764948144
              </p>
            </MDBCol>
          </MDBRow>
        </MDBContainer>
